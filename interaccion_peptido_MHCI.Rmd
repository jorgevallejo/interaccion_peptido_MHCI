...
La **topología** de la red describe el número de neuronas por capa, el número de capas, y cómo se conectan unas con otras.

El **algoritmo de entrenamiento** configura la forma en que ponderan los datos que se transmiten por cada nodo, una forma de modular las señales que viajan por la red _adicional a la función de activación_.
