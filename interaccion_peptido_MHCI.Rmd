...
## Modelo de tres nodos ocultos entrenado con validación cruzada de 5 particiones
...
## Modelo gaussiano ocultos entrenado con validación cruzada de 5 particiones
```{r create cross-validation method}
...
rownames(svm_evaluation_table2) <- c("Modelo Lineal", "Modelo Gaussiano",
                                 "Gaussiano con validación cruzada")
```
...
**El modelo gaussiano con validación cruzada** podría ser la mejor solución comparando los tres modelos construidos mediante SVM, ya que **combina la sensibilidad del modelo gaussiano con casi los mismos niveles de especificidad y precisión del modelo lineal**.
